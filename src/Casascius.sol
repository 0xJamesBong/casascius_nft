...
//     address public ut;
//     IZi public utilityToken = IZi(ut);
...
//     //     address asset = tokenId_to_metadata[tokenId].asset;
//     //     uint256 facevalue = tokenId_to_metadata[tokenId].facevalue;
//     //     uint256 jackpotClaims = tokenId_to_metadata[tokenId].jackpotClaims;
//     //     uint256 _decimals = getDecimalsByAsset(asset);
//     //     uint256 facevalue_adjusted_by_asset_decimals = facevalue *
//     //         uint256(10) ** _decimals;
...
//     //         toBeRedeemed = intact.add(amountETH).add(jackpotClaims);
...
//     //         toBeBurned = payment.sub(tributeToLPDesired).add(amountUt);
//     //         distributeAssets(toBeDistributed, asset);
//     //         toBeRedeemed = intact.add(amountAsset).add(jackpotClaims);
//     //         bool _success = IERC20(asset).transferFrom(
//     //             address(this),
//     //             msg.sender,
//     //             toBeRedeemed
...
//         uint256 facevalue = tokenId_to_metadata[tokenId].facevalue;
//         uint256 jackpotClaims = tokenId_to_metadata[tokenId].jackpotClaims;
//         (uint256 toBeBurned, bool success) = emergencyRedeemAddLiquidity(
//             asset,
//             payment,
//             facevalue,
//             jackpotClaims
...
//     function emergencyRedeemAddLiquidity(
//         address asset,
//         uint256 payment,
//         uint256 facevalue,
//         uint256 jackpotClaims
//     ) internal returns (uint256 toBeBurned, bool success) {
//         uint256 tributeToLPDesired = payment.div(3);
...
//         // uint256 toBeDistributed = retained - amountMin;
//         distributeAssets(retained - amountMin, asset);
...
//         uint256 liquidity;
//         if (asset == eth) {
//             (amountUt, residualAmount, liquidity) = IUniswapV2Router02(
//                 utilityToken_eth_pool
//             ).addLiquidityETH{value: amountMin}(
//                 ut,
//                 tributeToLPDesired,
//                 1,
//                 amountMin,
...
//                 ? utilityToken_wbtc_pool
//                 : utilityToken_sfrxEth_pool;
//             (amountUt, residualAmount, liquidity) = IUniswapV2Router02(pool)
//                 .addLiquidity(
//                     ut,
//                     asset,
//                     tributeToLPDesired,
...
//                 );
//         }
//         (bool success, uint256 toBeBurned) = emergencyBurnAndRedeem(
//             asset,
//             payment,
//             tributeToLPDesired,
//             amountUt,
...
//     function emergencyBurnAndRedeem(
//         address asset,
//         uint256 payment,
//         uint256 tributeToLPDesired,
//         uint256 amountUt,
//         uint256 residualAmount,
//         uint256 intact,
//         uint256 jackpotClaims,
//         uint256 _liquidity
//     ) internal returns (bool success, uint256 toBeBurned) {
//         uint256 toBeBurned;
//         uint256 toBeRedeemed;

//         if (asset == eth) {
//             toBeBurned = payment.sub(tributeToLPDesired).add(amountUt);
//             toBeRedeemed = intact.add(residualAmount).add(jackpotClaims);

//             (bool success, ) = payable(msg.sender).call{value: toBeRedeemed}(
//                 ""
//             );
//             require(success, "transaction didn't go through");

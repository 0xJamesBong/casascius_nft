...
//     function test_cannot_mint_beyond_totalSupply() public {}
...
contract Zi_Test is Zi_Setup {
        ...
        public
    {
        ...
        // Bob can mint now
        vm.prank(bob);
        zi.mint(bob, bob_mint_amount);
        assertEq(zi.totalSupply(), zi.initialSupply() + bob_mint_amount);
        assertEq(zi.balanceOf(bob), bob_mint_amount);
        // Bob can burn now
        vm.prank(bob);
        zi.burn(bob, bob_burn_amount);
        assertEq(
            zi.totalSupply(),
